...
//        initCsvWriter(response, vesselsList);
//
//
//    }
//
//    private void initCsvWriter(HttpServletResponse response, Collection<VesselStatus> vesselsList) throws IOException {
//        DateFormat dateFormatter = new SimpleDateFormat("yyyy-MM-dd_HH:mm:ss");
//        String currentDateTime = dateFormatter.format(new Date());
//        String filename = "status " + currentDateTime + ".csv";
//
...
//
//        //create a csv writer
//        StatefulBeanToCsv<VesselStatus> writer = new StatefulBeanToCsvBuilder<VesselStatus>
//                (response.getWriter())
