...
public class AlertsController {
     ...
     */
    @GetMapping("/report")
    public ResponseEntity<Collection<Alerts>> getReport0()
            throws ResourceNotFoundException {
        Collection<Alerts> alert =
                alertsRepository
                        .getReport0(DateUtils.toDate("9/21/2020"),DateUtils.toDate("9/21/2020"));
...
//    public ResponseEntity<Collection<Alerts>> getReport1(@PathVariable(value = "tenantId") String tenantId)
//            throws ResourceNotFoundException {
//        Collection<Alerts> alert =
//                alertsRepository
//                        .getReport1(tenantId);
...
//     * @throws ResourceNotFoundException the resource not found exception
//     */
//    @GetMapping("/report/{tenantId1}/{tenantId2}")
//    public ResponseEntity<Collection<Alerts>> getReport2(@PathVariable(value = "tenantId") String tenantId1, @PathVariable(value = "tenantId") String tenantId2)
//            throws ResourceNotFoundException {
//        Collection<Alerts> alert =
//                alertsRepository
//                        .getReport2(tenantId1, tenantId2);
//
//        return ResponseEntity.ok().body(alert);
//    }
